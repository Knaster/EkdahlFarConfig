...
class Ui_Form_AHDSR(object):
    def setupUi(self, Form_AHDSR):
        ...
        self.dialAmplitude.setEnabled(True)
...
#endif
        self.dialAmplitude.setPalette(palette)
        self.dialAmplitude.setAutoFillBackground(False)
        self.dialAmplitude.setStyleSheet(u"")
        self.dialAmplitude.setMaximum(65535)
        self.dialAmplitude.setSingleStep(100)
        self.dialAmplitude.setPageStep(1000)
        self.dialAmplitude.setTracking(True)
        ...
        self.dialAmplitude.setNotchesVisible(True)
